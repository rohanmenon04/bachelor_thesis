"""
Script 3 — Linear Probing for Semantic Alignment
==================================================
...
def main():
    ...
    vq_model.load_state_dict(torch.load('checkpoints/vq_encoder/vq_encoder.pt',         map_location='cpu'))

    cont_model = ContinuousEncoder()
    cont_model.load_state_dict(torch.load('checkpoints/vq_encoder/continuous_encoder.pt', map_location='cpu'))
