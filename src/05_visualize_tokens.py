...
def main():
    ...
    model.load_state_dict(torch.load('checkpoints/semantic_encoder.pt', map_location='cpu'))
    ...
    plot_gallery(observations, labels, token_indices, top_tokens, 'plots/ppo_baselines/token_gallery.png')
    plot_semantic_heatmap(labels, token_indices, 'plots/ppo_baselines/token_semantic_heatmap.png')

    print("\nAll done. Plots saved to plots/ppo_baselines/")
