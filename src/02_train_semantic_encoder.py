"""
Script 2 — Semantic Encoder Training
=============================
...
Usage:
  python 02_train_semantic_encoder.py
...
def main():
    ...
    vq_model.cpu()
    torch.save(vq_model.state_dict(), 'checkpoints/semantic_encoder.pt')
    print("Saved checkpoints/semantic_encoder.pt")
    ...
    print("\nNext: python 03_evaluate_representations.py")
