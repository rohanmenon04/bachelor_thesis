"""
Script 6 — PPO Condition E: LSTM over VQ Token Stream
==========================================================
...
Compare with:
  Condition C (04_ppo_conditions.py): MLP on single codebook embedding — no memory
  Condition D (04_ppo_conditions.py): MLP on 8-token window — fixed history
...
Usage:
  python 06_ppo_condition_e_lstm.py
...
class FrozenVQEncoder(nn.Module):
    ...
    def __init__(self, ckpt_path='checkpoints/semantic_encoder.pt'):
        super().__init__()
